...
function setupMenuContext()
{
	...
	$context['allow_admin'] = allowedTo(array('admin_forum', 'manage_boards', 'sp_admin', 'sp_manage_settings', 'sp_manage_blocks', 'sp_manage_articles', 'sp_manage_pages', 'sp_manage_shoutbox', 'manage_permissions', 'moderate_forum', 'manage_membergroups', 'manage_bans', 'send_mail', 'edit_news', 'manage_attachments', 'manage_smileys', 'sp_anime_manager','sp_anime_manager_series','sp_anime_manager_chapters', 'sp_anime_manager_news'));
		...
		/*	'search' => array(
            ...
            'Series' => array(
				...
				'sub_buttons' => array(
					...
					'Finalizadas' => array(
						'title' => $txt['finalizadas'],
						'href' => $scripturl . '?page=finalizadas',
						'show' => true,
					),
				),
			),
            ...
            'IRC' => array(
				'title' => $txt['irc'],
				'href' => $scripturl . '?page=irc',
				'show' => true,
				'sub_buttons' => array(
                    'IRC Staff' => array(
                        'title' => 'IRC Staff',
                        'href' => $scripturl . '?page=ircstaff',
                        'show' => allowedTo(array('sp_admin', 'sp_anime_manager','sp_anime_manager_series','sp_anime_manager_chapters', 'sp_anime_manager_news')),
                    ),
				),
			),
    ...
    //var use with pages of Simple Portal...
    $curPageURL = 'http';
        if (!empty($_SERVER["HTTPS"]) && $_SERVER["HTTPS"] == "on") {$curPageURL .= "s";}
            $curPageURL .= "://";
    ...
    elseif ($curPageURL == $scripturl . '?page=ayuda')
		$current_action = 'help';
    elseif ($curPageURL == $scripturl . '?page=proceso')
		$current_action = 'Series';
    elseif ($curPageURL == $scripturl . '?page=finalizadas')
		$current_action = 'Series';
    elseif ($curPageURL == $scripturl . '?page=irc')
		$current_action = 'IRC';
    elseif ($curPageURL == $scripturl . '?page=ircstaff')
		$current_action = 'IRC';
