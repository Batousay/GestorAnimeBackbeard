<?php
// Version: 2.3.3; SPortalHelp
// Last Revision: Monday, September 27 by Nathaniel.
...
$helptxt['sp-blocksPermissionType'] = 'This option enables permissions to be used on blocks. If the member needs to be in all of the groups allowed to see the block, one of the groups, or none of the groups (which would be ignoring permissions) it can be set here.
<ul>
<li><strong>One Membergroup</strong>: The member must be in one of the selected groups in order to see the block.</li>
<li><strong>All Membergroups</strong>: The member must be in all the selected groups in order to see the block.</li>
<li><strong>Ignore Permission</strong>: Every member and guest is allowed to see this block.</li>
</ul>';
...
$helptxt['sp_param_sp_rssFeed_titles_only'] = 'Displays feed titles, without content.';
